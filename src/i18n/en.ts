    ...
    steps: [
      {
        n: "01",
        title: "Dissect",
        desc: "Every project starts with the core problem. We peel away assumptions until we know what really needs to be solved. We haven't done everything before, and that's normal. We develop new products. If we had done it before, there would be nothing new about it. What the client can explain to us would be crazy to go figure out ourselves. So we start there. Then we do the rest.",
      },
      {
        n: "02",
        title: "Design",
  ...
  cases: {
    ...
    projects: [
      ...
      },
      {
        ...
        problem:
          "A nurse call handset that needed to work in two orientations. Cable out the top when hanging, cable out the bottom when docked. Fully waterproof in both, and the housing must remain watertight after every swap. Every configuration choice had to survive daily use in care environments.",
