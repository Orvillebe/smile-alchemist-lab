...
export default function NameSection() {
  return (
    <section className="bg-background px-6 md:px-[60px] py-[88px]">
      <Fade>
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-10 md:gap-[60px] max-w-[1100px] items-start">
          <div>
